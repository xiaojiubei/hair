...
INSERT INTO `fa_admin_log` (`id`, `admin_id`, `username`, `url`, `title`, `content`, `ip`, `useragent`, `createtime`) VALUES
	...
	(2, 1, 'admin', '/gzjrwVDeSZ.php/index/login', '登录', '{"__token__":"***","username":"admin","password":"***","captcha":"drvh"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158341),
	(3, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"command","force":"0","uid":"20050","token":"***","version":"1.1.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158416),
	(4, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"command","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158416),
	(5, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"example","force":"0","uid":"20050","token":"***","version":"1.1.3","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158420),
	(6, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"example","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158420),
	(7, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"darktheme","force":"0","uid":"20050","token":"***","version":"1.2.4","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158465),
	(8, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"darktheme","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158465),
	(9, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"epay","force":"0","uid":"20050","token":"***","version":"1.3.6","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158475),
	(10, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"epay","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158475),
	(11, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"filewatcher","force":"0","uid":"20050","token":"***","version":"1.0.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158481),
	(12, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"filewatcher","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158481),
	(13, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"wechat","force":"0","uid":"20050","token":"***","version":"1.2.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158486),
	(14, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"wechat","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158486),
	(15, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"third","force":"0","uid":"20050","token":"***","version":"1.4.4","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158489),
	(16, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"third","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158489),
	(17, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"invite","force":"0","uid":"20050","token":"***","version":"1.0.1","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158494),
	(18, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"invite","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158494),
	(19, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"hwsms","force":"0","uid":"20050","token":"***","version":"1.0.1","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158501),
	(20, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"hwsms","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158501),
	(21, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"recharge","force":"0","uid":"20050","token":"***","version":"1.1.3","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158508),
	(22, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"recharge","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158508),
	(23, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"markdown","force":"0","uid":"20050","token":"***","version":"1.2.3","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158519),
	(24, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"markdown","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158519),
	(25, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"loginbg","force":"0","uid":"20050","token":"***","version":"1.0.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158531),
	(26, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"loginbg","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158531),
	(27, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"qrcode","force":"0","uid":"20050","token":"***","version":"1.0.7","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158537),
	(28, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"qrcode","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158537),
	(29, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"betterform","force":"0","uid":"20050","token":"***","version":"1.0.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158542),
	(30, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"betterform","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158542),
	(31, 1, 'admin', '/gzjrwVDeSZ.php/addon/config?name=betterform&dialog=1', '插件管理 / 配置', '{"name":"betterform","dialog":"1","row":{"asteriskposition":"before","offset":"r","anim":"slideLeft","area":"[&quot;60%&quot;, &quot;100%&quot;]","shade":"0.3","shadeClose":"1"}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158551),
	(32, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"csp","force":"0","uid":"20050","token":"***","version":"1.0.0","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158558),
	(33, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"csp","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158559),
	(34, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"baidupush","force":"0","uid":"20050","token":"***","version":"1.0.3","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158570),
	(35, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"baidupush","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158570),
	(36, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"xunsearch","force":"0","uid":"20050","token":"***","version":"1.0.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158574),
	(37, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"xunsearch","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158574),
	(38, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"captcha","force":"0","uid":"20050","token":"***","version":"1.0.1","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158583),
	(39, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"captcha","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158583),
	(40, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"withdraw","force":"0","uid":"20050","token":"***","version":"1.1.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158586),
	(41, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"withdraw","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158586),
	(42, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"clicaptcha","force":"0","uid":"20050","token":"***","version":"1.1.4","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158598),
	(43, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"clicaptcha","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158598),
	(44, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"signin","force":"0","uid":"20050","token":"***","version":"1.0.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158604),
	(45, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"signin","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158604),
	(46, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"cropper","force":"0","uid":"20050","token":"***","version":"1.1.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158608),
	(47, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"cropper","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158608),
	(48, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"togglesidebar","force":"0","uid":"20050","token":"***","version":"1.0.1","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158614),
	(49, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"togglesidebar","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158614),
	(50, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"editable","force":"0","uid":"20050","token":"***","version":"1.0.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158621),
	(51, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"editable","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158621),
	(52, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"loginvideo","force":"0","uid":"20050","token":"***","version":"1.0.1","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158627),
	(53, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"loginvideo","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158627),
	(54, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"address","force":"0","uid":"20050","token":"***","version":"1.1.8","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158634),
	(55, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"address","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158634),
	(56, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"simditor","force":"0","uid":"20050","token":"***","version":"1.0.7","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158638),
	(57, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"simditor","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158638),
	(58, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"crontab","force":"0","uid":"20050","token":"***","version":"1.1.2","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158642),
	(59, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"crontab","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158643),
	(60, 1, 'admin', '/gzjrwVDeSZ.php/addon/install', '插件管理', '{"name":"database","force":"0","uid":"20050","token":"***","version":"1.0.14","faversion":"1.6.0.20240401"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158646),
	(61, 1, 'admin', '/gzjrwVDeSZ.php/addon/state', '插件管理 / 禁用启用', '{"name":"database","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 1729158646),
...
CREATE TABLE IF NOT EXISTS `fa_area` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=3749 DEFAULT CHARSET=utf8mb4 COMMENT='地区表';

-- 正在导出表  hair.fa_area 的数据：~3,758 rows (大约)
DELETE FROM `fa_area`;
...
-- 正在导出表  hair.fa_attachment 的数据：~0 rows (大约)
DELETE FROM `fa_attachment`;
...
-- 正在导出表  hair.fa_auth_group 的数据：~4 rows (大约)
DELETE FROM `fa_auth_group`;
...
-- 导出  表 hair.fa_auth_group_access 结构
...
-- 正在导出表  hair.fa_auth_group_access 的数据：~0 rows (大约)
DELETE FROM `fa_auth_group_access`;
INSERT INTO `fa_auth_group_access` (`uid`, `group_id`) VALUES
	(1, 1);

-- 导出  表 hair.fa_auth_rule 结构
...
INSERT INTO `fa_auth_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `createtime`, `updatetime`, `weigh`, `status`) VALUES
	...
	(89, 'file', 85, 'command/command', '生成并执行命令', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'scbzxml', 'shengchengbingzhixingmingling', 1729158416, 1729158416, 0, 'normal'),
	...
	(97, 'file', 94, 'example/bootstraptable/change', '变更', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bg', 'biangeng', 1729158420, 1729158420, 0, 'normal'),
	(98, 'file', 94, 'example/bootstraptable/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(99, 'file', 94, 'example/bootstraptable/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(100, 'file', 93, 'example/customsearch', '自定义搜索', 'fa fa-table', '', '', '', 1, NULL, '', 'zdyss', 'zidingyisousuo', 1729158420, 1729158420, 0, 'normal'),
	(101, 'file', 100, 'example/customsearch/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(102, 'file', 100, 'example/customsearch/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(103, 'file', 100, 'example/customsearch/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(104, 'file', 93, 'example/customform', '自定义表单示例', 'fa fa-edit', '', '', '', 1, NULL, '', 'zdybdsl', 'zidingyibiaodanshili', 1729158420, 1729158420, 0, 'normal'),
	(105, 'file', 104, 'example/customform/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(106, 'file', 93, 'example/tablelink', '表格联动示例', 'fa fa-table', '', '', '点击左侧日志列表，右侧的表格数据会显示指定管理员的日志列表', 1, NULL, '', 'bgldsl', 'biaogeliandongshili', 1729158420, 1729158420, 0, 'normal'),
	(107, 'file', 106, 'example/tablelink/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(108, 'file', 93, 'example/colorbadge', '彩色角标', 'fa fa-table', '', '', '左侧彩色的角标会根据当前数据量的大小进行更新', 1, NULL, '', 'csjb', 'caisejiaobiao', 1729158420, 1729158420, 0, 'normal'),
	(109, 'file', 108, 'example/colorbadge/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(110, 'file', 108, 'example/colorbadge/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(111, 'file', 108, 'example/colorbadge/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(112, 'file', 93, 'example/controllerjump', '控制器间跳转', 'fa fa-table', '', '', '点击IP地址可以跳转到新的选项卡中查看指定IP的数据', 1, NULL, '', 'kzqjtz', 'kongzhiqijiantiaozhuan', 1729158420, 1729158420, 0, 'normal'),
	(113, 'file', 112, 'example/controllerjump/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(114, 'file', 112, 'example/controllerjump/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(115, 'file', 112, 'example/controllerjump/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(116, 'file', 93, 'example/cxselect', '多级联动', 'fa fa-table', '', '', '基于jquery.cxselect实现的多级联动', 1, NULL, '', 'djld', 'duojiliandong', 1729158420, 1729158420, 0, 'normal'),
	(117, 'file', 116, 'example/cxselect/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(118, 'file', 116, 'example/cxselect/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(119, 'file', 116, 'example/cxselect/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(120, 'file', 93, 'example/multitable', '多表格示例', 'fa fa-table', '', '', '展示在一个页面显示多个Bootstrap-table表格', 1, NULL, '', 'dbgsl', 'duobiaogeshili', 1729158420, 1729158420, 0, 'normal'),
	(121, 'file', 120, 'example/multitable/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(122, 'file', 120, 'example/multitable/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(123, 'file', 120, 'example/multitable/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(124, 'file', 93, 'example/relationmodel', '关联模型示例', 'fa fa-table', '', '', '列表中的头像、用户名和昵称字段均从关联表中取出', 1, NULL, '', 'glmxsl', 'guanlianmoxingshili', 1729158420, 1729158420, 0, 'normal'),
	(125, 'file', 124, 'example/relationmodel/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(126, 'file', 124, 'example/relationmodel/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	(127, 'file', 124, 'example/relationmodel/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158420, 1729158420, 0, 'normal'),
	(128, 'file', 93, 'example/tabletemplate', '表格模板示例', 'fa fa-table', '', '', '', 1, NULL, '', 'bgmbsl', 'biaogemubanshili', 1729158420, 1729158420, 0, 'normal'),
	(129, 'file', 128, 'example/tabletemplate/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158420, 1729158420, 0, 'normal'),
	(130, 'file', 128, 'example/tabletemplate/detail', '详情', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xq', 'xiangqing', 1729158420, 1729158420, 0, 'normal'),
	(131, 'file', 128, 'example/tabletemplate/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158420, 1729158420, 0, 'normal'),
	...
	(139, 'file', 136, 'wechat/autoreply/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158486, 1729158486, 0, 'normal'),
	(140, 'file', 136, 'wechat/autoreply/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158486, 1729158486, 0, 'normal'),
	(141, 'file', 136, 'wechat/autoreply/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158486, 1729158486, 0, 'normal'),
	(142, 'file', 135, 'wechat/config', '配置管理', 'fa fa-cog', '', '', '', 1, NULL, '', 'pzgl', 'peizhiguanli', 1729158486, 1729158486, 0, 'normal'),
	(143, 'file', 142, 'wechat/config/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158486, 1729158486, 0, 'normal'),
	(144, 'file', 142, 'wechat/config/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158486, 1729158486, 0, 'normal'),
	(145, 'file', 142, 'wechat/config/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158486, 1729158486, 0, 'normal'),
	(146, 'file', 142, 'wechat/config/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158486, 1729158486, 0, 'normal'),
	(147, 'file', 142, 'wechat/config/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158486, 1729158486, 0, 'normal'),
	(148, 'file', 135, 'wechat/menu', '菜单管理', 'fa fa-list', '', '', '', 1, NULL, '', 'cdgl', 'caidanguanli', 1729158486, 1729158486, 0, 'normal'),
	(149, 'file', 148, 'wechat/menu/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158486, 1729158486, 0, 'normal'),
	(150, 'file', 148, 'wechat/menu/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158486, 1729158486, 0, 'normal'),
	(151, 'file', 148, 'wechat/menu/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158486, 1729158486, 0, 'normal'),
	(152, 'file', 148, 'wechat/menu/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158486, 1729158486, 0, 'normal'),
	(153, 'file', 148, 'wechat/menu/remote', '加载远程菜单', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'jzyccd', 'jiazaiyuanchengcaidan', 1729158486, 1729158486, 0, 'normal'),
	(154, 'file', 148, 'wechat/menu/sync', '同步', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tb', 'tongbu', 1729158486, 1729158486, 0, 'normal'),
	(155, 'file', 148, 'wechat/menu/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158486, 1729158486, 0, 'normal'),
	(156, 'file', 135, 'wechat/response', '资源管理', 'fa fa-list-alt', '', '', '', 1, NULL, '', 'zygl', 'ziyuanguanli', 1729158486, 1729158486, 0, 'normal'),
	(157, 'file', 156, 'wechat/response/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158486, 1729158486, 0, 'normal'),
	(158, 'file', 156, 'wechat/response/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158486, 1729158486, 0, 'normal'),
	(159, 'file', 156, 'wechat/response/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158486, 1729158486, 0, 'normal'),
	...
	(167, 'file', 166, 'user/moneylog/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158507, 1729158507, 0, 'normal'),
	(168, 'file', 166, 'user/moneylog/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158507, 1729158507, 0, 'normal'),
	(169, 'file', 166, 'user/moneylog/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158507, 1729158507, 0, 'normal'),
	(170, 'file', 166, 'user/moneylog/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158508, 1729158508, 0, 'normal'),
	(171, 'file', 166, 'user/moneylog/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158508, 1729158508, 0, 'normal'),
	(172, 'file', 66, 'user/scorelog', '会员积分日志', 'fa fa-list', '', '', '', 1, NULL, '', 'hyjfrz', 'huiyuanjifenrizhi', 1729158508, 1729158508, 0, 'normal'),
	(173, 'file', 172, 'user/scorelog/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158508, 1729158508, 0, 'normal'),
	(174, 'file', 172, 'user/scorelog/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158508, 1729158508, 0, 'normal'),
	...
	(186, 'file', 183, 'xunsearch/project/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158574, 1729158574, 0, 'normal'),
	(187, 'file', 183, 'xunsearch/project/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158574, 1729158574, 0, 'normal'),
	(188, 'file', 183, 'xunsearch/project/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158574, 1729158574, 0, 'normal'),
	(189, 'file', 183, 'xunsearch/project/reset', '重置索引', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zzsy', 'zhongzhisuoyin', 1729158574, 1729158574, 0, 'normal'),
	(190, 'file', 183, 'xunsearch/project/refresh', '生成配置', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'scpz', 'shengchengpeizhi', 1729158574, 1729158574, 0, 'normal'),
	(191, 'file', 183, 'xunsearch/project/flush', '强制刷新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'qzsx', 'qiangzhishuaxin', 1729158574, 1729158574, 0, 'normal'),
	(192, 'file', 183, 'xunsearch/project/config', '加载配置', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'jzpz', 'jiazaipeizhi', 1729158574, 1729158574, 0, 'normal'),
	(193, 'file', 182, 'xunsearch/fields', '字段管理', 'fa fa-list', '', '', '管理项目索引的字段，如果增加了字段，请确保相应的整合接口有写入该字段数据', 0, NULL, '', 'zdgl', 'ziduanguanli', 1729158574, 1729158574, 0, 'normal'),
	(194, 'file', 193, 'xunsearch/fields/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158574, 1729158574, 0, 'normal'),
	(195, 'file', 193, 'xunsearch/fields/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158574, 1729158574, 0, 'normal'),
	(196, 'file', 193, 'xunsearch/fields/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158574, 1729158574, 0, 'normal'),
	(197, 'file', 193, 'xunsearch/fields/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158574, 1729158574, 0, 'normal'),
	(198, 'file', 193, 'xunsearch/fields/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158574, 1729158574, 0, 'normal'),
	(199, 'file', 182, 'xunsearch/logger', '搜索词管理', 'fa fa-list', '', '', '此列表结果由Xunsearch服务记录，提供如果搜索词没有相应的搜索结果，Xunsearch不会记录该记录值', 0, NULL, '', 'sscgl', 'sousuociguanli', 1729158574, 1729158574, 0, 'normal'),
	(200, 'file', 199, 'xunsearch/logger/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158574, 1729158574, 0, 'normal'),
	(201, 'file', 199, 'xunsearch/logger/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158574, 1729158574, 0, 'normal'),
	(202, 'file', 199, 'xunsearch/logger/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1729158574, 1729158574, 0, 'normal'),
	(203, 'file', 199, 'xunsearch/logger/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158574, 1729158574, 0, 'normal'),
	(204, 'file', 199, 'xunsearch/logger/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158574, 1729158574, 0, 'normal'),
	(205, 'file', 66, 'user/withdraw', '会员提现管理', 'fa fa-money', '', '', '', 1, NULL, '', 'hytxgl', 'huiyuantixianguanli', 1729158586, 1729158586, 0, 'normal'),
	(206, 'file', 205, 'user/withdraw/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158586, 1729158586, 0, 'normal'),
	(207, 'file', 205, 'user/withdraw/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158586, 1729158586, 0, 'normal'),
	...
	(215, 'file', 211, 'signin/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158604, 1729158604, 0, 'normal'),
	(216, 'file', 211, 'signin/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158604, 1729158604, 0, 'normal'),
	(217, 'file', 2, 'general/crontab', '定时任务', 'fa fa-tasks', '', '', '按照设定的时间进行任务的执行,目前支持三种任务:请求URL、执行SQL、执行Shell。', 1, NULL, '', 'dsrw', 'dingshirenwu', 1729158642, 1729158642, 0, 'normal'),
	(218, 'file', 217, 'general/crontab/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158642, 1729158642, 0, 'normal'),
	(219, 'file', 217, 'general/crontab/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1729158642, 1729158642, 0, 'normal'),
	(220, 'file', 217, 'general/crontab/edit', '编辑 ', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1729158642, 1729158642, 0, 'normal'),
	(221, 'file', 217, 'general/crontab/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1729158642, 1729158642, 0, 'normal'),
	(222, 'file', 217, 'general/crontab/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1729158642, 1729158642, 0, 'normal'),
	(223, 'file', 2, 'general/database', '数据库管理', 'fa fa-database', '', '', '可进行一些简单的数据库表优化或修复，查看表结构和数据，也可以进行SQL语句的操作', 1, NULL, '', 'sjkgl', 'shujukuguanli', 1729158646, 1729158646, 0, 'normal'),
	(224, 'file', 223, 'general/database/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1729158646, 1729158646, 0, 'normal'),
	...
	(238, 'file', 234, 'test/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1729158741, 1729158741, 0, 'normal'),
...
-- 正在导出表  hair.fa_category 的数据：~13 rows (大约)
...
-- 正在导出表  hair.fa_command 的数据：~0 rows (大约)
DELETE FROM `fa_command`;

-- 导出  表 hair.fa_config 结构
...
-- 正在导出表  hair.fa_config 的数据：~18 rows (大约)
...
-- 正在导出表  hair.fa_crontab 的数据：~2 rows (大约)
DELETE FROM `fa_crontab`;
...
-- 正在导出表  hair.fa_crontab_log 的数据：~0 rows (大约)
DELETE FROM `fa_crontab_log`;
...
-- 正在导出表  hair.fa_invite 的数据：~0 rows (大约)
DELETE FROM `fa_invite`;

-- 导出  表 hair.fa_recharge_order 结构
...
-- 正在导出表  hair.fa_recharge_order 的数据：~0 rows (大约)
DELETE FROM `fa_recharge_order`;

-- 导出  表 hair.fa_signin 结构
...
-- 正在导出表  hair.fa_signin 的数据：~0 rows (大约)
DELETE FROM `fa_signin`;
...
-- 正在导出表  hair.fa_sms 的数据：~0 rows (大约)
DELETE FROM `fa_sms`;

-- 导出  表 hair.fa_test 结构
...
-- 正在导出表  hair.fa_test 的数据：~0 rows (大约)
DELETE FROM `fa_test`;
...
-- 正在导出表  hair.fa_third 的数据：~0 rows (大约)
DELETE FROM `fa_third`;

-- 导出  表 hair.fa_user 结构
...
-- 正在导出表  hair.fa_user 的数据：~0 rows (大约)
DELETE FROM `fa_user`;
INSERT INTO `fa_user` (`id`, `group_id`, `username`, `nickname`, `password`, `salt`, `email`, `mobile`, `avatar`, `level`, `gender`, `birthday`, `bio`, `money`, `score`, `successions`, `maxsuccessions`, `prevtime`, `logintime`, `loginip`, `loginfailure`, `joinip`, `jointime`, `createtime`, `updatetime`, `token`, `status`, `verification`) VALUES
	(1, 1, 'admin', 'admin', 'e1572aa0c1ec947da72482f15b693802', '20a07a', 'admin@163.com', '13000000000', 'http://hair.init/assets/img/avatar.png', 0, 0, '2017-04-08', '', 0.00, 0, 1, 1, 1491635035, 1491635035, '127.0.0.1', 0, '127.0.0.1', 1491635035, 0, 1491635035, '', 'normal', '');

-- 导出  表 hair.fa_user_group 结构
...
-- 正在导出表  hair.fa_user_group 的数据：~0 rows (大约)
DELETE FROM `fa_user_group`;
...
-- 导出  表 hair.fa_user_money_log 结构
...
-- 正在导出表  hair.fa_user_money_log 的数据：~0 rows (大约)
DELETE FROM `fa_user_money_log`;

-- 导出  表 hair.fa_user_rule 结构
...
-- 正在导出表  hair.fa_user_rule 的数据：~0 rows (大约)
DELETE FROM `fa_user_rule`;
...
-- 导出  表 hair.fa_user_score_log 结构
...
-- 正在导出表  hair.fa_user_score_log 的数据：~0 rows (大约)
DELETE FROM `fa_user_score_log`;

-- 导出  表 hair.fa_user_token 结构
...
-- 正在导出表  hair.fa_user_token 的数据：~0 rows (大约)
DELETE FROM `fa_user_token`;

-- 导出  表 hair.fa_version 结构
...
-- 正在导出表  hair.fa_version 的数据：~1 rows (大约)
DELETE FROM `fa_version`;
...
-- 导出  表 hair.fa_wechat_autoreply 结构
...
-- 正在导出表  hair.fa_wechat_autoreply 的数据：~2 rows (大约)
DELETE FROM `fa_wechat_autoreply`;
INSERT INTO `fa_wechat_autoreply` (`id`, `title`, `text`, `eventkey`, `remark`, `weigh`, `createtime`, `updatetime`, `status`) VALUES
	(1, '输入hello', 'hello', '58c7d908c4570', '', 1, 1493366855, 1493366855, 'normal'),
	(2, '输入你好', '你好', '58fdfaa9e1965', '', 2, 1493704976, 1493704976, 'normal');

-- 导出  表 hair.fa_wechat_captcha 结构
...
-- 正在导出表  hair.fa_wechat_captcha 的数据：~0 rows (大约)
DELETE FROM `fa_wechat_captcha`;

-- 导出  表 hair.fa_wechat_config 结构
...
-- 正在导出表  hair.fa_wechat_config 的数据：~3 rows (大约)
DELETE FROM `fa_wechat_config`;
INSERT INTO `fa_wechat_config` (`id`, `name`, `title`, `value`, `createtime`, `updatetime`) VALUES
...
-- 导出  表 hair.fa_wechat_context 结构
...
-- 正在导出表  hair.fa_wechat_context 的数据：~0 rows (大约)
DELETE FROM `fa_wechat_context`;

-- 导出  表 hair.fa_wechat_response 结构
...
-- 正在导出表  hair.fa_wechat_response 的数据：~4 rows (大约)
DELETE FROM `fa_wechat_response`;
INSERT INTO `fa_wechat_response` (`id`, `title`, `eventkey`, `type`, `content`, `remark`, `createtime`, `updatetime`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `fa_withdraw` (
  ...
  `memo` varchar(255) DEFAULT NULL COMMENT '备注',
  `orderid` varchar(100) DEFAULT '' COMMENT '订单号',
  `transactionid` varchar(100) DEFAULT '' COMMENT '流水号',
...
-- 正在导出表  hair.fa_withdraw 的数据：~0 rows (大约)
DELETE FROM `fa_withdraw`;

-- 导出  表 hair.fa_xunsearch_fields 结构
CREATE TABLE IF NOT EXISTS `fa_xunsearch_fields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  hair.fa_xunsearch_fields 的数据：~0 rows (大约)
DELETE FROM `fa_xunsearch_fields`;

-- 导出  表 hair.fa_xunsearch_project 结构
CREATE TABLE IF NOT EXISTS `fa_xunsearch_project` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  hair.fa_xunsearch_project 的数据：~0 rows (大约)
DELETE FROM `fa_xunsearch_project`;
